...
Strategy.prototype._authenticate_saml = function (req) {
  console.log("In authenticate saml");
  var self = this;
...
Strategy.prototype.authenticate = function (req, opts) {
  ...
  function executeWsfed(req) {
	...
	console.log("In strategy authenticate else");
  ...
  function executeSamlp(req) {
	...
	//console.log("After validating saml response : " + err);
	...
	/*console.dir(profile);*/
      ...
      console.log("Sending  new authentication request");
